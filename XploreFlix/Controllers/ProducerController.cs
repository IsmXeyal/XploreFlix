...
public class ProducerController : Controller
{
    ...
    public ProducerController(IProducerRepository ProducRepo, IMovieRepository MovRepo, XploreFlixDbContext _db)
    {
    ...
    {
        List<Producer> Producers = (List<Producer>)producerRepository.GetAll()!;
    ...
    public ActionResult Create(Producer NewProducer, List<IFormFile> Image)
    {
        ...
        {
            Task<int> numOfRowsInsertion = producerRepository.InsertAsync(NewProducer, Image);
    ...
    public ActionResult Edit(Producer EditProducer, int id, List<IFormFile> Image)
    {
        if (ModelState.IsValid)
        {
            Task<int> numOfRowsUpdated = producerRepository.UpdateAsync(EditProducer, id, Image);
            return RedirectToAction("AdminProducers");
        }
        return RedirectToAction("Producer");
